...
class CarV2 implements EngineV2, VehicleV2 {
    // re-implementing br.com.bmo.java8tips.model method fix compiler complain
...
public class MultipleInheritance {
    public static void main(String[] args) {
        ...
        System.out.println("carv2 carV2.br.com.bmo.java8tips.model(1) " + carV2.model(1));

        CarV3 carV3 = new CarV3();
        System.out.println("carv3 carV3.br.com.bmo.java8tips.model(1) " + carV3.model(1));
